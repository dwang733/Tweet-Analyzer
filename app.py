...
@app.before_request
def load_user():
    # If user in session, allow all requests to have access to User object
...
def twitter_login():
    ...
    # Request token from Twitter and redirect to Twitter
...
def search():
    ...
    tweet_texts = [{'tweet': tweet['text']} for tweet in tweets['statuses']]
